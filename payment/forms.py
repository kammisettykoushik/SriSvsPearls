...
class ShippingForm(forms.ModelForm):
    ...
    shipping_address1 = forms.CharField(label="", widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Flat,House no.,Suite,Building,Apartment,Company'}),
                                         required=True)
    shipping_address2 = forms.CharField(label="", widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Area,Street,Landmark'}),
                                         required=True)
...
class PaymentForm(forms.Form):
    ...
    card_number = forms.CharField(label="", widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Card Number'}),
                                         required=True)
    card_exp_number = forms.CharField(label="", widget=forms.TextInput(
